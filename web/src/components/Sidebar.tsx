    ...
    <aside aria-label="Session sidebar" className="w-full md:w-[260px] h-full flex flex-col bg-cc-sidebar">
      ...
      <div className="p-3.5 pb-2">
        <div className="flex items-center gap-2.5">
          ...
          <span className="text-[13px] font-semibold text-cc-fg tracking-tight">Neuron Spark Code</span>
          <button
      ...
      <div className="px-2 py-1.5 pb-safe bg-cc-sidebar-footer border-t border-cc-border/30">
        ...
        <button
          ...
          title="Sign out"
          className="mt-1.5 w-full flex items-center justify-center gap-1.5 py-2 px-2 rounded-lg text-cc-muted hover:text-red-500 hover:bg-red-500/10 transition-colors cursor-pointer"
        >
